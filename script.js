...
const lirikLagu = [
    ...
    { waktu: 7.8, teks: "Betapa beruntungnya" },
    { waktu: 11.5, teks: "Ada cinta seperti cintamu" },
    { waktu: 15.0, teks: "kepadaku hoo" },
    { waktu: 20.2, teks: "Cukup aku milikmu dan kamu milikku" },
    { waktu: 24.8, teks: "Tetap di sampingku sampai jadi debu" },
    { waktu: 27.5, teks: "Sampai akhir waktu" },
    { waktu: 29.8, teks: "sampai maut yang bersaksi" },
    { waktu: 33.0, teks: "Cintaku abadi" },
    { waktu: 36.8, teks: "Dan bila aku terlahir seribu kali lagi" },
    { waktu: 41.2, teks: "Di dunia yang lain aku tak peduli" },
    { waktu: 46.2, teks: "Kau akan kucari sampai kau tau betapa kau kucintai" },
    { waktu: 62.8, teks: "Seribu kali lagi kau kan kucintai (kau kan kucintai)" },
    { waktu: 72.2, teks: "Cukup aku milikmu kau milikku (tetap disampingku)" },
    { waktu: 80.2, teks: "Sampai jadi debu sampai akhir waktu" },
    { waktu: 88.8, teks: "Hooo kau tetap milikku" },
    { waktu: 98.2, teks: "Detak di jantungku cintaku abadi" },
    { waktu: 112.2, teks: "Seribu kali lagi aku tak peduli" },
    { waktu: 121.2, teks: "Sampai kau tau betapa kau kucintai Hiii" },
    { waktu: 135.2, teks: "Kau akan kucari" }
];
